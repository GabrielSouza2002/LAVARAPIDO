...
<main>
  ...
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <form action="cadastra_veiculo.php" method="POST">
        <fieldset>
          <legend><h2>Cadastro de veículos</h2></legend>
          <br>
          <br>
          <br>
          <br>
  ...
  <form action="cadastra_veiculo.php" method="POST">
          ...
          <div class="form-floating mb-4">
            <input class="form-control" id="nome" name="nome" placeholder="Nome do veículo">
            <label for="floatingPassword">NOME</label>
          </div>
          <div class="form-floating mb-4">
            <input class="form-control" id="modelo" name="modelo" placeholder="Modelo">
            <label for="floatingPassword">MODELO</label>
          </div>
          <div class="form-floating mb-4">
            <input class="form-control" id="placa" name="placa" placeholder="Placa">
            <label for="floatingPassword">PLACA</label>
          </div>

          <label for="cliente"> Cliente </label>
          <?php echo listaClienteSelect()?>
